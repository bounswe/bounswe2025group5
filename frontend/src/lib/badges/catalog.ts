...
export const badgeCatalog: BadgeCatalogItem[] = [
  ...
  { key: 'badges.badgeNames.plasticLegend', descriptionKey: 'badges.badgeDescriptions.plasticLegend', category: 'waste', priority: 2, iconUrl: plasticLegendIcon },
  ...
  { key: 'badges.badgeNames.paperLegend', descriptionKey: 'badges.badgeDescriptions.paperLegend', category: 'waste', priority: 3, iconUrl: paperLegendIcon },
  ...
  { key: 'badges.badgeNames.glassLegend', descriptionKey: 'badges.badgeDescriptions.glassLegend', category: 'waste', priority: 4, iconUrl: glassLegendIcon },
  ...
  { key: 'badges.badgeNames.metalLegend', descriptionKey: 'badges.badgeDescriptions.metalLegend', category: 'waste', priority: 5, iconUrl: metalLegendIcon },
  ...
  { key: 'badges.badgeNames.organicLegend', descriptionKey: 'badges.badgeDescriptions.organicLegend', category: 'waste', priority: 6, iconUrl: organicLegendIcon },
  { key: 'badges.badgeNames.topChallenger', descriptionKey: 'badges.badgeDescriptions.topChallenger', category: 'challenge', priority: 1, iconUrl: topChallengerIcon },
